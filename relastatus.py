...
class Pet:
    def __init__(self, name, desc, tag, type, stages, expreq, stage=0, evolvesinto=None, playmessage=None):
        self.name = name
        self.desc = desc
        self.tag = tag
        self.type = type
...
20012, "Unknown", 3, 0, 3, playmessage="encases you in itself and goes jumping through shadows with you")
...
20018, "Mammal", 3, 0, 3, playmessage="Transforms, knocks you down, and licks you")
dragon = Pet("Dodongo", "It's powerful, you can ride on it, it's cool, what else could you want?", 20023, "Reptile",
3, 0, 3, playmessage="Puts you on it's back and runs at amazing speeds")

# Tier 2 Pets
bbdino = Pet("Bigger Dinosaur", "It has quite the apetite", 20002, "Reptillian", 3, 1200, 2, trex, "roars and lifts you up with its head")
lilraven = Pet("Chick", "Can't help but to rub it's black sleek feathers", 20005, "Bird", 3, 800, 2, 
raven, "stares at you as you stare at it, then chirps")
luxio = Pet("Luxio", "It's sooooo cool. It surges with energy", 20008, "Mammal", 3, 1000, 2, luxray, "discharges electricty and tackles you affectionately")
...
meagle = Pet("Chick", "It's power is growing at a rapid rate, Likes meat", 20014, "Bird", 3, 900, 2, eagle, "Extends it's growing wings and rubs your hand")
tstig = Pet("Transforming Cub", "Changes shape from time to time while playing with you", 20017, "Mammal",
3, 800, 2, tstiger, "transforms into various creatures in it's excitement and circles you.")
tree = Pet("The Tree", "A large tree with facial features not needing water. It's leaves look fun to ride on", 20020, "Plant",
2, 0, 2, "Picks you up, places you on it's powerful large leaves, and walks around")
...
monkey = Pet("Monkey de mimicry", "Likes to mimic you", 20025, "Mammal", 2, 0, 2, "claps it's hands and begins to mimic you")

# Tier 1 Pets
bdino = Pet("Baby Dinosaur", "I'm the baby, gotta love me", 20001, "Reptilian", 3, 350, 2, bbdino, "bites your hand and smiles, but it doesn't have teeth")
bird = Pet("Hatchling", "Awww, isn't it the cutest", 20004, "Bird",3, 225, 1, lilraven, "ruffles it's feathers at your touch")
shinx = Pet("Shinx", "Powerfully shocking. Who would have guessed", 20007, "Mammal", 3, 250,1, luxio, "Zaps you with stored electricity, careful not to hurt you")
...
bbeag = Pet("Hatchling", "There's a kind of menacing look in it's eyes", 20013, "Bird", 3, 700, 1, meagle, "screeches and gently nips your finger")
tcub = Pet("Tiger Cub", "Extremely playful and energetic", 20016, "Mammal", 3, 200, 1, tstig, "rubs against your leg")
sapling = Pet("Sapling", "Wait... what? It's so cool though. Uses leaves to hover around", 20019, "Plant", 2, 1000, 1, tree,
"floats up and hovers around your head")
bblizard = Pet("Baby Lizard", "It's little legs scuttle around so quickly over your body", 20021, "Reptile", 3,
400, 1, lizard, "excitedly runs around in circles")
