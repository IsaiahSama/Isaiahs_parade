...
Available categories are Action, Battle, Mod, Misc, gaming, general and social""")
        ...
        await ctx.send(f"We have {len(mycommands)} commands")
...
quest6 = MyHelp("Battle", "Quest6", "<>quest6", "Usable only by members in Tier 6", "<>q6", "5 minutes")
...
reborn = MyHelp("Battle", "Reborn", "<>reborn", "Must be tier 6. Allows you to go back to tier 1 and progress again. You keep 1% hp and 3% of other stats added on to the base. Crit and Healchance remain unaffected. All gear stats increase by 3% + your reborn level.")
...
enemies = MyHelp("Battle", "Enemies", "<>enemies", "Shows all enemies in your tier.")
...
zawarudo = MyHelp("Mod", "ZA WARUDO", "<>zawarudo time", "Stops everyone without manage channel permissions from speaking in the channel for that duration. Essentially a channel mute", "<>shhh")
...
denylove, denyparent, dump, feed, getpet, newbff, newchild, pet, play, showfriends, updatesocial, socialprofile, nickpet]
